...
export class ChatComponent implements OnInit {
    ...
    async sendWebsites(prompt: string) {
        ...
        this.messages += `<div class="alert alert-info">Adding possible live website context to conversation. Multiple URLs may take longer to process. Please wait.<span class="mt-4 timestamp timestamp-system">${this.getTimestamp()}</span></div>`;
